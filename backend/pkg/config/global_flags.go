...
var OciRuntimeBinary string = "runc"
...
func InitGlobalFlags(command *cobra.Command) {
	...
	command.PersistentFlags().StringVar(&OciRuntimeBinary, "oci-runtime-bin", "runc", "OCI runtime binary used to run one-shot containers")
